...
external_df <- "examples//perm2/example_data_file.csv"
...
concfile <- "examples//perm2/example_conc_file.conc"
...
output_directory="examples//perm2/"
...
wave <- "examples//perm2/example_wave_file.csv"
...
output_permfile = 'examples//perm2/perms_group1/permfile.txt1'
