...
external_df <- "examples//perm3/example_data_file.csv"
...
concfile <- "examples//perm3/example_conc_file.conc"
...
output_directory="examples//perm3/"
...
wave <- "examples//perm3/example_wave_file.csv"
...
output_permfile = 'examples//perm3/perms_group1/permfile.txt1'
