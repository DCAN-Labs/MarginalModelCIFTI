...
external_df <- "examples//perm5/example_data_file.csv"
...
concfile <- "examples//perm5/example_conc_file.conc"
...
output_directory="examples//perm5/"
...
wave <- "examples//perm5/example_wave_file.csv"
...
output_permfile = 'examples//perm5/perms_group1/permfile.txt1'
