...
external_df <- "examples//perm1/example_data_file.csv"
...
concfile <- "examples//perm1/example_conc_file.conc"
...
output_directory="examples//perm1/"
...
wave <- "examples//perm1/example_wave_file.csv"
...
output_permfile = 'examples//perm1/perms_group1/permfile.txt1'
